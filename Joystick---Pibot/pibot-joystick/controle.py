...
#=======================================================================
def move_left(power):
    pwmA.ChangeDutyCycle(0) #muda a potência dos motores
...
#=======================================================================
def get_command():
    pl = 30 #potência aplicada ao motor esquerdo
    pr = 30 #potência aplicada ao motor direito
    p = 100  #potência aplicad a ambos os motores quando girar à esquerda
